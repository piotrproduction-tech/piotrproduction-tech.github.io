// MarketplaceDistrict — DistrictIdentityEngine_9_2
// Nakładka na 9.1 z emergent identity 9.2.

import { MarketplaceDistrict_IdentityEngine_9_1 } from "./MarketplaceDistrict_IdentityEngine_9_1.js";
import { MarketplaceDistrict_EmergentState_9_2 } from "../models/MarketplaceDistrict_EmergentState_9_2.js";
import { MarketplaceDistrict_LongTermMemory_9_2 } from "../models/MarketplaceDistrict_LongTermMemory_9_2.js";
import { MarketplaceDistrict_ArchetypeEvolver_9_2 } from "../models/MarketplaceDistrict_ArchetypeEvolver_9_2.js";

export class MarketplaceDistrict_IdentityEngine_9_2 {
  constructor(baseArchetype = "BASE") {
    this.baseEngine = new MarketplaceDistrict_IdentityEngine_9_1();
    this.emergent = new MarketplaceDistrict_EmergentState_9_2();
    this.longTerm = new MarketplaceDistrict_LongTermMemory_9_2();
    this.evolver = new MarketplaceDistrict_ArchetypeEvolver_9_2(baseArchetype);
  }
