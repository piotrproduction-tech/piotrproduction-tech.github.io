...
export function createCitySelfReflection({
  ...
  function generateInsight(analysis, governance, ethics, spirit) {
    if (!analysis.ai) return "Miasto zastanawia si nad cisz AI.";

    if (!governance.allowed) return "Miasto czuje, e decyzja AI naruszya prawo.";
    ...
    if (analysis.viewChange) return "Miasto zauwaa zmian perspektywy.";

    return "Miasto akceptuje swoj decyzj i idzie dalej.";
  }
