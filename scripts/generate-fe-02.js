...
`,
  ...
  // TEST
  "__tests__/director-engine.test.js": `
...
function generateFE02() {
  const baseDir = path.join(ROOT, "apps", "FE-02__AI_Director");
  ...
  console.log("\n🎉 FE‑02 AI Director Engine + Profiles generated successfully.");
}
