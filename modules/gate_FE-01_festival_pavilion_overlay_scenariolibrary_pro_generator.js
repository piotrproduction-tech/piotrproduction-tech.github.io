...
function scenarioLibraryPro() {
  const file = path.join(CORE, "festivalOverlayScenarioLibraryPro.js");
  const marker = "// FE_FESTIVAL_OVERLAY_SCENARIOLIBRARY_PRO";
...
function main() {
  console.log("=== FestivalOverlayScenarioLibraryPro Generator ===");
  ensureDir(CORE);
  scenarioLibraryPro();
  console.log("=== DONE ===");
}
