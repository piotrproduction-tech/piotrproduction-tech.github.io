...
//
// 1. core/useFestivalOverlayRemoteControl.js
//
function remoteControlHook() {
  const file = path.join(CORE, "useFestivalOverlayRemoteControl.js");
  const marker = "// FE_FESTIVAL_OVERLAY_REMOTECONTROL_HOOK";
...
function integrateController() {
  ...
  const marker = "// FE_FESTIVAL_OVERLAY_REMOTECONTROL_INTEGRATION";
...
function integrateOverlay() {
  ...
  const marker = "// FE_FESTIVAL_OVERLAY_REMOTECONTROL_OVERLAY";
...
function main() {
  console.log("=== FestivalOverlayRemoteControl Generator ===");
  ensureDir(CORE);
  remoteControlHook();
  integrateController();
  integrateOverlay();
