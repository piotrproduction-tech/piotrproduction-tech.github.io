...
//
// 1. ULTRA dynamic scenario library
//
function scenarioLibraryUltra() {
  const file = path.join(CORE, "festivalOverlayScenarioLibraryUltra.js");
  const marker = "// FE_FESTIVAL_OVERLAY_SCENARIOLIBRARY_ULTRA";
...
function main() {
  console.log("=== FestivalOverlayScenarioLibraryUltra Generator ===");
  ensureDir(CORE);
  scenarioLibraryUltra();
  console.log("=== DONE ===");
}
