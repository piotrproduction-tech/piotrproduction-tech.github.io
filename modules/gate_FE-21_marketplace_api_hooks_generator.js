...
function getHookTemplate() {
  return `// FE-21__Marketplace - api/useMarketplaceApi.js
...
function main() {
  console.log("=== FE-21 Marketplace API Hooks generator start ===");
  ...
  const apiDir = path.join(FE21, "api");
  ensureDir(apiDir);

  writeFileIfMissing(
    path.join(apiDir, "useMarketplaceApi.js"),
    getHookTemplate()
  );

  console.log("=== FE-21 Marketplace API Hooks generator done ===");
}
