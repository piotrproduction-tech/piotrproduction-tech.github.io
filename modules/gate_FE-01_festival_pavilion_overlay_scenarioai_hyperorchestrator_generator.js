...
//
// 1. HyperOrchestrator module
//
function hyperOrchestratorModule() {
  const file = path.join(CORE, "useFestivalOverlayScenarioAIHyperOrchestrator.js");
  const marker = "// FE_FESTIVAL_OVERLAY_SCENARIO_AI_HYPERORCHESTRATOR";
...
function integrateController() {
  ...
  const marker = "// FE_FESTIVAL_OVERLAY_SCENARIO_AI_HYPERORCHESTRATOR_INTEGRATION";
...
function main() {
  console.log("=== FestivalOverlayScenarioAIHyperOrchestrator Generator ===");
  ensureDir(CORE);
  hyperOrchestratorModule();
  integrateController();
  console.log("=== DONE ===");
}
